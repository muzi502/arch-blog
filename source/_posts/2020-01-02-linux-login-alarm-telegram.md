...
![image-20200102212730956](./img/image-20200102212730956.png)

### 注册 bot

#### 1.打开与 @BotFather 的对话框

![image-20200102213100935](./img/image-20200102213100935.png)

#### 2.发送/start 开始会话

![image-20200102213250311](./img/image-20200102213250311.png)

#### 3.发送/newbot

![image-20200102213314119](./img/image-20200102213314119.png)
...
![image-20200102213405851](./img/image-20200102213405851.png)
...
![image-20200102214900940](./img/image-20200102214900940.png)
...
![image-20200102220002156](./img/image-20200102220002156.png)

#### 7. 和 bot 对话

这一步非常重要，当 bot 新建完成之后就点击你的 bot 链接，然后在点击下面的 start 按钮。你不点击 start 开始和 bot 会话的话，bot 是无法想你发送信息的。我就在这个坑里爬了很久😂

![image-20200102215325530](./img/image-20200102215325530.png)
...
![image-20200102220642854](./img/image-20200102220642854.png)
...
![image-20200102222349027](./img/image-20200102222349027.png)
