...
![小米摄像头](https://img.502.li/1561802376885.jpg)
...
![POE供电摄像头](https://img.502.li/1561802376888.jpg)

![POE供电图解](https://img.502.li/1561802376886.jpg.jpg)

找了半天最终还是找到了一个摄像头，价格也比较便宜😂。特意问了卖家能不能通过浏览器访问、能不能不需要专用的摄像机来访问摄像头。卖家说是可以的。

![1570702505815](https://img.502.li/1570702505815.png)

![1570702514509](https://img.502.li/1570702514509.png)

## 安装摄像头

把路由器的电源适配器输出接口给剪了，又接了一个 DC 2.5mm 的插头，这样一个电源适配器同时供路由器和摄像头使用了😂。不用担心功率，一个摄像头和路由器总功耗还不到 8W。

![推荐这个12V直流电源，某宝搜关键字😂](https://img.502.li/1570704495847.png)

![将摄像头底座固定在一个塑料板上，再用螺丝刀插入空调海绵胶里固定住😂](https://img.502.li/1570702447664.png)

![路由器放在了空调上面，互不干扰](https://img.502.li/1570702472108.png)

穹妹哦😂，骨科？

![1570702482302](https://img.502.li/1570702482302.png)

![一个RJ45的网线接口和一个12V的DC供电接口](https://img.502.li/1570702739896.png)

## 配置摄像头

询问卖家怎么配置摄像头，卖家说搜索雄迈，然后下载相应的工具。[配套软件下载 ](https://www.xiongmaitech.com/service/down_detail1/83/176) 下载安装就行。

![配套软件](https://img.502.li/1570704765775.png)

![在设备管理里添加摄像头](https://img.502.li/1570704813188.png)

![默认是没有密码的，设置密码了酒店及铅笔✏图标哪里设置密码](https://img.502.li/1570704875787.png)

![配置摄像头界面](https://img.502.li/1570704956430.png)

![网络设置-TCP/IP](https://img.502.li/1570704990621.png)

![RTSP 设置，这个后面要用到](https://img.502.li/1570705020709.png)
...
![PotPlayer 里在打开那里选择打开连接](https://img.502.li/1570705646007.png)

![输入上述 URL ](https://img.502.li/1570705720287.png)
