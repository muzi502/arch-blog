...
![1564128425387](./img/1564128425387.png)

**测试文件数量和大小**

![1564128874832](./img/1564128874832.png)

**使用 xargs 执行 256 个进程并发上传 10w 张照片所用所用时间 为 2 分钟左右（内网）**

![1564128721547](./img/1564128721547.png)

**用时 2 分 11 秒**

![1564364594777](./img/1564364594777.png)

**客户端负载情况**

![1564127683217](./img/1564127683217.png)

**服务端负载情况**

![1564364294952](./img/1564364294952.png)

**服务端带宽流量**

![1564365025177](./img/1564365025177.png)

**服务端带宽流量**

![服务端带宽流量](./img/1564363829960.png)

**服务端上传结果**

![1564125161155](./img/1564125161155.png)

**服务端上传日志记录 ，均无错误输出**

![1564130238346](./img/1564130238346.png)
...
![1564130789416](./img/1564130789416.png)

**wget 下载**

使用 `wget -i` 参数指定 `url.log` 为标准输出来测试下载刚刚上传的 10W 张图片 用时 3 分 23 秒

![1564023927851](./img/1564023927851.png)
