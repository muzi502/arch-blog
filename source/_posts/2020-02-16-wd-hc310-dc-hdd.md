...
![img](https://img.502.li/data-sheet-ultrastar-dc-hc310-1.png)

![hc310](https://img.502.li/data-sheet-ultrastar-dc-hc310-2.png)
...
![](https://img.502.li/data-sheet-ultrastar-dc-hc320-1.png)

![data-sheet-ultrastar-dc-hc320-2](https://img.502.li/data-sheet-ultrastar-dc-hc320-2.png)
...
![](https://img.502.li/data-sheet-ultrastar-dc-hc330-1.png)

![data-sheet-ultrastar-dc-hc330-2](https://img.502.li/data-sheet-ultrastar-dc-hc330-2.png)
...
![Ultrastar SATA Series Data Sheet](https://img.502.li/data-sheet-ultrastar-sata-series-2879-810017_2-1.png)

![](https://img.502.li/data-sheet-ultrastar-sata-series-2879-810017_2-2.png)
...
![img](https://img.502.li/lmr.jpg)

-   PMR：Perpendicular Magnetic Recording，垂直磁记录

![img](https://img.502.li/pmr.jpg)
...
![image-20200212174711937](https://img.502.li/image-20200212174711937.png)

#### 保护效果极佳

![image-20200212174744908](https://img.502.li/image-20200212174744908.png)

#### 本体外包装，锡纸包裹，两个字，奢华！

![image-20200212174815949](https://img.502.li/image-20200212174815949.png)

#### 硬盘本体，是 2019 年 12 月份泰国制造

![image-20200212174935106](https://img.502.li/image-20200212174935106.png)

#### 硬盘背面，排线那里部分有明显的接触痕迹，应该是测试过的

![image-20200212175033523](https://img.502.li/image-20200212175033523.png)

#### 使用了八年的东芝 500GB/7200RPM 硬盘

![image-20200212175143454](https://img.502.li/image-20200212175143454.png)

#### 厚度对比，因为多了三个碟片的缘故，西数的重量明显重很多

![image-20200212175252411](https://img.502.li/image-20200212175252411.png)

#### dell 3010 机箱自带的硬盘托架，安装起来也十分方便😋

![image-20200212175337800](https://img.502.li/image-20200212175337800.png)

#### 安装效果图

![image-20200212175353147](https://img.502.li/image-20200212175353147.png)
...
![image-20200212200929031](https://img.502.li/image-20200212200929031.png)

### CrystalDiskMark

![image-20200212201510213](https://img.502.li/image-20200212201510213.png)

### AIAD

![image-20200212202516267](https://img.502.li/image-20200212202516267.png)

### ATTO

写入和读取测试 32GB 数据，可以看到从 8KB Transfer Size 开始就稳定在 260MB/s 以上，牛皮啊，不愧是`最强盘王`，在 7200 RPM 规格里可以说是王者了，吊打那些掉速后的 TLC 固态不大吧（偷笑

![image-20200212205214388](https://img.502.li/image-20200212205214388.png)

-   IO/s

![image-20200212205246224](https://img.502.li/image-20200212205246224.png)

### 复制文件 SSD –> HDD

从固态 `WD_BLACK SN750 NVMe SSD` 往 HC310 里复制 [宇宙时空之旅]() 超清纪录片 80GB ，速度基本上都稳定在 220MB/s 以上。这速度基本上和那些掉速后的 TLC/QLC  固态（SATA）差不多了😂。

![image-20200212183603192](https://img.502.li/image-20200212183603192.png)

### HDD –> SSD

从 HC310 往固态 `WD_BLACK SN750 NVMe SSD` 里复制速度基本上也是在 220MB/S 以上。

![image-20200212184205712](https://img.502.li/image-20200212184205712.png)

### CrystalDiskInfo

![image-20200212152058875](https://img.502.li/image-20200212152058875.png)
...
![image-20200212185539226](https://img.502.li/image-20200212185539226.png)

![image-20200212184904891](https://img.502.li/image-20200212184904891.png)
